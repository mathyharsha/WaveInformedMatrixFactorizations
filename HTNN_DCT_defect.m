...
% Undamaged
    ...
    %  Discrete Cosine Transform (DCT)
      ...
      Positions_defect{indx} = HTNN_DCT_defect_pos;
      WavePower_est{indx} = disp_wave_power_est;

end


      save('./results/HTNN_DCT_defect.mat','Positions_defect',"WavePower_est")
